...
class SquareLottieView : LottieAnimationView {
    ...
    private fun initialize(
        ...
        attrs?.let {
            context.obtainStyledAttributes(
                it, R.styleable.SquareLottieView, defStyleAttr, 0
            ).apply {
                mSquaredBy = getInt(R.styleable.SquareLottieView_frsx_SquaredBy, SQUARED_BY_WIDTH)
                recycle()
            }
        }
    }
