...
class SquareFrameLayout : LinearLayoutCompat {
    ...
    private fun initialize(
        ...
        attrs?.let {
            context.obtainStyledAttributes(
                it, R.styleable.SquareFrameLayout, defStyleAttr, 0
            ).apply {
                mSquaredBy = getInt(R.styleable.SquareFrameLayout_frsx_SquaredBy, SQUARED_BY_WIDTH)
                recycle()
            }
        }
    }
