...
class SquareLinearLayout : LinearLayoutCompat {
    ...
    private fun initialize(
        ...
        attrs?.let {
            context.obtainStyledAttributes(
                it, R.styleable.SquareLinearLayout, defStyleAttr, 0
            ).apply {
                mSquaredBy = getInt(R.styleable.SquareLinearLayout_frsx_SquaredBy, SQUARED_BY_WIDTH)
                recycle()
            }
        }
    }
